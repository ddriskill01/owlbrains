...
$tcpp_biznamefull = "Owl Brians"; // e.g. "Owl Brains" or ""
$tcpp_bizname = "Owl Brains"; // e.g. "Owl Brains"
$tcpp_biznamepossessive = "Owl Brains'"; // e.g. "Owl Brains'"


$tcpp_domainname = "OwlBrains.com"; // e.g. "WordPress.com"

$tcpp_websiteurl = "http://www.owlbrains.com"; // e.g. "http://www.wordpress.com/"
...
$tcpp_timeperiodforchangingfeesandfornotifications = "30"; // e.g. "thirty (30) days"
$tcpp_timeperiodtoreplytopriorityemail = "one business day"; // e.g. "one business day"

$tcpp_timeperiodfordeterminingmaximumdamages = "twelve (12) month"; // e.g. "twelve (12) month"
...
$tcpp_venue = "state of Nevada, USA"; // e.g. "state of California, U.S.A."
$tcpp_courtlocation = "Clark County, Nevada"; // e.g. "San Francisco County, California"
$tcpp_arbitrationlocation = "Las Vegas, Nevada"; // e.g. "San Francisco, California"
